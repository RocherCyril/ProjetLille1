...
public class ListChoser {
	...
	// ...methode chose...
	//
	public chose(int num,List<?> list){
		System.out.println("Chose one of the stuff in this list : ")
		System.out.println("Number : 0 for nothing");
		for(int i=0;i<list.size();i++){
			System.out.prinln("Number : ".i." is a : ".list.get(i));
		}
		ScannerInt scan=new ScannerInt();
		int n = scan.readInt();
		if(n==0){
			return(null);
		}
